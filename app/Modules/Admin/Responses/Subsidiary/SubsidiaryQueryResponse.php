...
namespace App\Modules\Admin\Responses\Subsidiary;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\ArrayHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SubsidiaryQueryResponse')]
class SubsidiaryQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SubsidiaryResponse::class))]
    private array $data;
